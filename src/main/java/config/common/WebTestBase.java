...
public class WebTestBase {
    ...
    // public static final String BROWSERSTACK_USERNAME = "alish_AoTGiS";
    //  public static final String BROWSERSTACK_ACCESS_KEY = "ijYaisC5gsrdAcBcPkKW";

    public static final String SAUCE_LABS_USERNAME = "oauth-bibirabucupon-a23e5";
    public static final String SAUCE_LABS_ACCESS_KEY = "b1827caa-9373-4458-93b5-75c1c67e2e57";
